  ...
  return (
    <section id="projects" className="py-10 px-6 md:px-12 transition-colors duration-300">
      <div className="max-w-[52rem] mx-auto">
        <div className="mb-8">
          <div className="text-2xl font-bold mb-6 text-neutral-800 dark:text-neutral-200 underline underline-offset-4 decoration-2 decoration-neutral-400 dark:decoration-neutral-600">
            Selected Work
          </div>
        </div>
        ...
        <div className="flex justify-center mt-12">
           <a 
             href="https://github.com/Prasidhpshetty7?tab=repositories"
             target="_blank" 
             rel="noreferrer"
